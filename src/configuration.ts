...
class Configuration {
  ...
  constructor() {
    ...
    this.oidcScopes = process.env.GENIE_OIDC_SCOPES || 'OPENID USER:READ PERSONA:READ PERSONA:PUBLIC_READ GENIE_MACHINE:READ GENIE_MACHINE:CREATE GENIE_MACHINE:UPDATE GENIE_MACHINE:DELETE GENIE_SESSION:READ GENIE_SESSION:CREATE GENIE_SESSION:UPDATE GENIE_SESSION:DELETE GENIE_SESSION_MESSAGE:READ GENIE_SESSION_MESSAGE:CREATE GENIE_SESSION_MESSAGE:UPDATE GENIE_SESSION_MESSAGE:DELETE'
